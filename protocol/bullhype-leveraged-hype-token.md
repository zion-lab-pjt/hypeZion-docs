...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/cvdQOULzcasMgbUwaABJ/protocol/bullhype-leveraged-hype-token
---
...
<p align="center"><span class="math">\textbf{Collateral TVL} = \textbf{MC(hzUSD)} + \textbf{MC(hzHYPE)}</span></p>
...
<p align="center"><span class="math">\text{Effective Leverage} = \dfrac{\text{Collateral TVL}}{\text{MC(bullHYPE)}}</span></p>
...
<p align="center"><span class="math">P_{hzHYPE} = \dfrac{\text{Collateral TVL} - \text{hzUSD Supply}}{\text{bullHYPE Supply}}</span></p>



Therefore, if Collateral appreciates, P\_bullHYPE surges rapidly, and conversely declines sharply during downturns.
