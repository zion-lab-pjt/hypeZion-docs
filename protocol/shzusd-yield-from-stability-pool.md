...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/cvdQOULzcasMgbUwaABJ/protocol/shzusd-yield-from-stability-pool
---
...
<p align="center"><span class="math">P_{shzUSD} = \dfrac{\text{Total SP Value}}{\text{Total shzUSD Supply}}</span></p>
...
<p align="center"><span class="math">V_{shzUSD} = \dfrac{\text{SP Assets (Collateral + Fees + Rewards)}}{\text{shzUSD Supply}}</span></p>
...
<p align="center"><span class="math">\text{CR} \downarrow \Rightarrow \text{SP Activation} \Rightarrow \text{Loss Absorption} \Rightarrow \text{NAV Recovery} \Rightarrow \text{CR} \uparrow</span></p>
