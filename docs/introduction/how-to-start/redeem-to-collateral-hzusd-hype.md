---
sidebar_position: 5
title: Redeem to Collateral (hzUSD → HYPE)
---
...
| Category             | Details                                                                    |
| -------------------- | -------------------------------------------------------------------------- |
| Market Deviation Risk| Short-term differences may occur between DEX price and internal rate.      |
| Fee Volatility Risk  | Fees may surge when Redeem demand concentrates.                            |
| Queue Delay Risk     | Time lags occur due to FIFO processing when large request volumes are generated. |
| Smart Contract Risk  | Even audited contracts are not completely risk-free.                       |
