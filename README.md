...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/cvdQOULzcasMgbUwaABJ/introduction/overview
---
...
1. **Buy hzUSD** — Acquire the stablecoin
2. **Earn Yield with hzUSD (shzUSD)** — Deposit to earn yield
3. **Buy Leveraged HYPE Tokens (bullHYPE)** — Acquire leveraged derivative assets
4. **Redeem to Collateral (hzUSD → HYPE)** — Convert stablecoin back to collateral
